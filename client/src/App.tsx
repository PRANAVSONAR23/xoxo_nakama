...
import { DoneMessage, OpCode, StartMessage, UpdateMessage } from './types';
...
export default function App() {
  ...
  return (
    <div className=''>
      <div className='p-6'>
        <div className='text-3xl text-center font-bold'>{gameMessage}</div>
      </div>
      <div className='flex justify-center items-center'>
        <button className='border-2 p-2 rounded-xl font-bold' onClick={findMatch}>Find Match</button>
      </div>
      {gameStarted && (
      ...
      <div className='flex flex-col  justify-center items-center  p-10'>
        <div className='flex  justify-center item-center rounded-xl w-fit '>
