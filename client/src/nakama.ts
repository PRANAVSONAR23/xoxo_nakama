...
class Nakama {
    ...
    constructor() {
        this.client = new Client("defaultkey",import.meta.env.VITE_PUBLIC_SERVER_API, import.meta.env.VITE_PUBLIC_SERVER_PORT, import.meta.env.VITE_PUBLIC_USE_SSL === "true");
    }
    ...
    async authenticate(): Promise<void> {
        ...
        const trace = false;
        this.socket = this.client.createSocket(import.meta.env.VITE_PUBLIC_USE_SSL === "true", trace);
